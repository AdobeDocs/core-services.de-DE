---
description: Erfahren Sie mehr über zentrale Komponenten der Benutzeroberfläche für CX Enterprise (ehemals Experience Cloud). Hier erhalten Sie Hilfe zur Benutzer- und Produktverwaltung, zum Aktivieren von Anwendungen für Dienste mit freigegebenen Schnittstellen. Hier erhalten Sie Hilfe zur Zielgruppenbibliothek, zu Kundenattributen, Assets und mehr.
title: Handbuch zur Benutzeroberfläche und Administration von CX Enterprise
...
# Benutzeroberfläche und Administration von CX Enterprise

[CX Enterprise](https://experience.adobe.com) (ehemals _Experience Cloud_) ist Adobes integrierte Produktfamilie von Programmen, Produkten und Services für Digital Marketing. Über die intuitive Benutzeroberfläche können Sie schnell auf Ihre Cloud-Programme, Produktfunktionen und Services zugreifen.

<!-- ![CX Enterprise](assets/landing.png) -->

In der Kopfzeile von CX Enterprise haben Sie folgende Möglichkeiten:

* Zugriff auf alle CX Enterprise-Programme und -Services
...
* CX Enterprise verwalten [Voreinstellungen](features/account-preferences.md)
