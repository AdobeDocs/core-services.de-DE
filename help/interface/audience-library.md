...
## Verwendung von Zielgruppen durch Anwendungen {#concept_01EB9345C5344597BC94A864EDD38EE1}

In der folgenden Tabelle wird beschrieben, wie Zielgruppen in Experience Cloud-Anwendungen verwendet werden:
...
| [!DNL Target] | Die [ID-Dienst](https://experienceleague.adobe.com/docs/id-service/using/home.html?lang=de) vereinheitlicht Besucher-IDs und Daten zu einem einsatzfähigen Profil für die Verwendung in allen Anwendungen. Wenn das Kontrollkästchen „[In Experience Cloud veröffentlichen](audience-library.md)“ während der Segmenterstellung in Adobe Analytics aktiviert wird, ist das Segment in der benutzerdefinierten Zielgruppenbibliothek von Adobe Target verfügbar. Ein in Analytics oder Audience Manager erstelltes Segment kann für Aktivitäten in [!DNL Target] verwendet werden. Sie können zum Beispiel Kampagnenaktivitäten basierend auf [!DNL Analytics]-Konversionsmetriken und in [!DNL Analytics] erstellten Zielgruppensegmenten erstellen. |
| Audience Manager | Freigegebene Zielgruppen sind in der Segmentierung von Audience Manager verfügbar. Alle Experience Cloud-Zielgruppen stehen systemintern in Audience Manager zur Verfügung. Dieser bietet Folgendes:<ul><li>Integrierte Automatisierung hinsichtlich der Freigabe und Verwendung in Anwendungs-Workflows</li><li>Offsite-Ziele</li><li>Look-Alike-Modellierung</li></ul> |
| Campaign | <ul><li>Importieren freigegebener Zielgruppen aus verschiedenen Adobe Experience Cloud-Anwendungen in Adobe Campaign.</li><li>Exportieren Sie Empfängerlisten in Form von freigegebenen Zielgruppen. Diese freigegebenen Zielgruppen können in den verschiedenen von Ihnen verwendeten Adobe Experience Cloud-Anwendungen verwendet werden.</li></ul> |
...
| Hilfe mit | Ressource |
|--- |--- |
| Es können keine Ressourcen gefunden werden? | Stellen Sie sicher, dass Sie bereitgestellt wurden. Siehe [Erste Schritte - Aktivieren Ihrer Anwendungen für Hauptdienste](core-services.md).<br>Klicken Sie [hier](https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?idx=X8SVES), um Zugriff auf Profile und Zielgruppen anzufordern (Integrations-Bereitstellungsformular). |
| Anwendungsfälle | Weitere Anleitungen zu der zu verwendenden Anwendung finden Sie unter [Optionen zur Zielgruppenerstellung](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-16471.html?lang=en) in der Wissensdatenbank. |
