...
| **Content Advisor Agent** | <ul><li>[Content Discovery](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/agents/discovery/overview): Hilft Teams dabei, mithilfe natürlicher Sprache schnell die relevantesten Inhalte im gesamten Unternehmen zu finden, wodurch die Zeit für die Suche verkürzt und Entscheidungen und die Ausführung beschleunigt werden können.</li><li>[Inhaltsoptimierung](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/agents/content-optimization/overview): Vereinfachen Sie die Erstellung visueller Inhaltsvarianten aus Quell-Assets mithilfe natürlicher Sprachaufforderungen.</li></ul> | <ul><li>Adobe Experience Manager (Content Discovery)</li></ul><ul><li>Adobe Experience Manager mit Dynamic Media mit OpenAPI (Inhaltsoptimierung)</li></ul><ul><li>Adobe Experience Manager Cloud Services und Edge Delivery Services (Erlebnisproduktion) </li></ul> |
...
| **Brand Experience Agent** | <ul><li>[Erlebnismodernisierung](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/agents/modernization/overview): Beschleunigt die Migration und Modernisierung digitaler Erlebnisse durch automatische Umstrukturierung, Anreicherung und Validierung vorhandener Sites, damit Teams schneller zu modernen, KI-fähigen Erlebnissen mit weniger Risiko und manuellem Aufwand wechseln können.</li><li>[Erlebnisproduktion](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/agents/production/overview)*: Ermöglicht die Erstellung und Aktualisierung umfangreicher Erlebnisse und reduziert so den manuellen Aufwand und die Zykluszeit erheblich, sodass Teams schneller arbeiten können, ohne Kompromisse bei Qualität oder Konsistenz eingehen zu müssen.</li><li>[Erstellung von Forms](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/agents/production/form-creation): Beschleunigt die Erstellung optimierter, markeninterner Formulare, indem Formulare automatisch generiert, strukturiert und validiert werden. Dadurch können Teams schneller starten und mit minimalem manuellen Aufwand Daten höherer Qualität erfassen.</li><li>[Entwicklungsunterstützung](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/agents/development/overview): Hilft Entwicklerinnen und Entwicklern sowie technischen Administratoren von AEM CS bei der Fehlerbehebung bei Build-Schritt-Fehlern in der Cloud Manager-Pipeline, indem die Grundursache analysiert und Fehlerbehebungen vorgeschlagen werden.</li></ul> | <ul><li>AEM SITES CS</li></ul><ul><li>AEM Sites</li></ul><ul><li>AEM Forms</li></ul><ul><li>Alle Cloud-basierten AEM-Apps</li></ul> |
| **Brand Governance Agent*** | <ul><li>[Brand Governance](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/agents/governance/overview):Safeguard Markenintegrität und Einhaltung automatisierter Markenrichtlinien, Prüfungen, Berechtigungen und Intelligenz zur Unterstützung von DRM mit Echtzeit-Governance.</li><li>[Erlebnisproduktion](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/ai-in-aem/agents/production/overview): Automatisiert aufwändige und umfangreiche Aufgaben in der CMS. Dieser Agent wandelt manuelle, langwierige Prozesse in schnelle, KI-gestützte Workflows um, die jedes Erlebnis aktuell und konsistent halten und Ihrem Unternehmen helfen, Ihre Ziele zu erreichen.</li> | <ul><li>AEM Assets</li></li></ul> |
