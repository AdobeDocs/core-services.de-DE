...
Um die Experience Cloud-Voreinstellungen zu finden, klicken Sie **[!UICONTROL Profil]** ![Voreinstellungen](../assets/preferences-icon-sm.png) in der Kopfzeile und anschließend auf **[!UICONTROL Voreinstellungen]**.
...
1. Nachdem Sie [!DNL Slack] Genehmigung erhalten haben, kehren Sie zu Experience Cloud **[!UICONTROL Benachrichtigungen]** zurück und führen Sie die Schritte [Abonnieren von Slack](#slack-notifications) (oben beschrieben) aus.
...
## Anzeigen [!UICONTROL Benachrichtigungen] und Ankündigungen in Experience Cloud {#view-notifications}
