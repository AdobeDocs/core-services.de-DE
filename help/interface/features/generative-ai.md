...
| [Adobe Experience Manager Sites](#aem) | Ja. <br> Verfügbar in [Varianten generieren](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) um Inhaltsvarianten basierend auf Eingaben zu erstellen. | Nicht zutreffend | Ja |
...
| | | AJO Prime und Ultimate bieten [Inhaltserstellung](https://experienceleague.adobe.com/de/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative?lang=en) um proaktive Inhaltsvariantenvorschläge für Text und Bilder einzubringen. | Ja |
...
| [[!DNL Workfront]](#workfront) | Ja. <br> In-App-Informationen und -Vorschläge. [Weitere Informationen](https://experienceleague.adobe.com/de/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en) | Nicht zutreffend | Ja |
