...
| Hilfe-Link | Beschreibung |
| ------- | ------- |
| [Adobe ID zurücksetzen](https://helpx.adobe.com/manage-account/kb/account-password-sign-help.html) | Melden Sie sich ab und klicken Sie dann auf **[!UICONTROL Get help signing in]** > **[!UICONTROL Reset your password]**. |
