...
| Hilfe-Link | Beschreibung |
| ------- | ------- |
| [Adobe ID zurücksetzen](https://helpx.adobe.com/manage-account/kb/account-password-sign-help.html) | Melden Sie sich ab und klicken Sie dann auf **[!UICONTROL Hilfe bei der Anmeldung]** > **[!UICONTROL Kennwort zurücksetzen]**. |
