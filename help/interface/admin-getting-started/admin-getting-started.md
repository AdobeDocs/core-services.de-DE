...
>[!IMPORTANT]
>
>Die folgenden Informationen richten sich speziell an Experience Cloud-Anwendungen. Diese Informationen ergänzen die umfassenderen administrativen Informationen im [Enterprise Administration-Benutzerhandbuch](https://helpx.adobe.com/de/enterprise/admin-guide.html) für alle Adobe Cloud-Produkte.

Im Admin Tool können Sie eine sortierbare und filterbare Liste aller Experience Cloud-Benutzer und deren Details anzeigen. Siehe [Anzeigen von Experience Cloud-Benutzern im Admin-Tool](admin-tool-experience-cloud.md).
...
* Siehe [Analytics-Zugriffsberechtigungen einem Produktprofil zuweisen](../admin-getting-started/admin-getting-started.md#task_040673FE3E3E429B9531FBCB8B6A4391) auf dieser Seite.
...
Weitere Informationen (und Hilfe zur Produktverwaltung für Creative Cloud und Document Cloud) finden Sie unter [Identität](https://helpx.adobe.com/enterprise/admin-guide.html/enterprise/using/identity.ug.html) im [Administrations-Benutzerhandbuch](https://helpx.adobe.com/enterprise/admin-guide.html/enterprise/using/users.ug.html).

**Verwandte Hilfe**

* [Verwalten Sie Produkte und ](https://helpx.adobe.com/enterprise/admin-guide.html/enterprise/using/manage-products.ug.html) Profile im Administrations-Benutzerhandbuch.
* [Enterprise-Benutzerberechtigungen](https://experienceleague.adobe.com/docs/target/using/administer/manage-users/enterprise/property-channel.html?lang=en) in der Hilfe zu Adobe Target.
...
1. Geben Sie die Administratorrechte des Benutzers an.
...
1. Klicken Sie auf der Seite [!UICONTROL Products] auf Ihr Produkt, klicken Sie dann auf **[!UICONTROL Permissions]** (nur für Administratoren verfügbar).
...
| Analytics-Tools | Gewähren Sie Benutzern Zugriff auf allgemeine Elemente (Rechnungsstellung, Protokolle usw.), Unternehmensverwaltung, Tools, Web Service-Zugriff, Report Builder und Data Connectors-Integration. Die Unternehmenseinstellungen aus der Kategorie „Anpassung der Admin Console“ sind nun in den Analytics-Tools zu finden. |
...
Weitere Informationen finden Sie unter [Migration der Analytics-Benutzer-ID](https://experienceleague.adobe.com/docs/analytics/admin/user-product-management/user-management/migrate-users/c-migration-tool.html?lang=en)
...
Informationen zu Sicherheitsgruppen und zum Zuweisen von Benutzern zu Sicherheitsgruppen finden Sie unter [Verwalten von Gruppen und Benutzern](https://experienceleague.adobe.com/docs/campaign-standard/using/administrating/users-and-security/managing-groups-and-users.html?lang=en).

## Verwalten der Experience Platform-Datenerfassung (Launch) {#section_F2DA6778DD2D48AA8F794041971EE6B1}

Experience Platform [!UICONTROL Datenerfassung] ([!UICONTROL Launch]) wird auf der Seite [!UICONTROL Produkte] in der Admin Console [!UICONTROL a7/> angezeigt. ] Sie können weitere Lösungen und Dienste in ein Launch-Produktprofil aufnehmen.

Laden Sie Benutzer zu [!UICONTROL Platform Launch] ein und weisen Sie ihnen Benutzerrollen und -rechte zu.

Informationen zu Benutzerberechtigungen in der Admin Console und zum Einrichten von Launch-spezifischen Optionen, einschließlich der Zuweisung von Berechtigungen zu Profilen, finden Sie unter [Benutzerberechtigungen](https://experienceleague.adobe.com/docs/launch/using/admin/user-permissions.html?lang=de#admin) .

## Experience Manager as a Cloud Service

Adobe Enterprise-Kunden werden in der Adobe [!UICONTROL Admin Console] als Organisationen dargestellt. Experience Manager (AEM)-Kunden können die Adobe [!UICONTROL Admin Console] verwenden, um Produktberechtigungen und die IMS-Authentifizierung für Experience Manager als [!UICONTROL Cloud Service] zu verwalten.

Siehe [IMS-Unterstützung für AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/security/ims-support.html?lang=de).
...
Siehe [Administration](https://experienceleague.adobe.com/docs/dtm/using/admin/users.html?lang=en) in der Hilfe zu Audience Manager.

## Unterstützte Browser in der Experience Cloud

* [!DNL Microsoft® Edge] (Microsoft® hat die Unterstützung  [für Internet Explorer 8, 9 und 10 ](https://www.microsoft.com/de-de/WindowsForBusiness/End-of-IE-support) eingestellt. Daher behebt Adobe keine Probleme, die in Verbindung mit diesen speziellen Versionen von Internet Explorer gemeldet werden.)
* [!DNL Google Chrome]
* [!DNL Firefox]
* [!DNL Safari]
* [!DNL Opera]

**Hinweis:** Obwohl die Experience Cloud-Oberfläche diese Browser unterstützt, unterstützen einzelne Anwendungen nicht alle Browser. ([Analytics](https://experienceleague.adobe.com/docs/analytics/admin/sys-reqs.html?lang=en) unterstützt beispielsweise nicht [!DNL Opera] und [Adobe Target](https://experienceleague.adobe.com/docs/target/using/implement-target/before-implement/supported-browsers.html?lang=en) unterstützt nicht [!DNL Safari].)
