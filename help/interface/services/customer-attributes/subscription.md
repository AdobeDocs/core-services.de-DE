...
[!DNL Customer Attributes]-Abonnements ermöglichen den Datenfluss von Kundenattributen zwischen CX Enterprise und Anwendungen ([!DNL Analytics] und [!DNL Target]).
...
1. Suchen Sie Ihre Datenquelle in [!DNL Customer Attributes] zur Bearbeitung:
   ...
   Klicken Sie [!DNL CX Enterprise] auf **[!UICONTROL Apps]** ![Menü](assets/menu-icon.png) > **[!DNL Customer Attributes]**.
...
1. Klicken Sie auf **[!UICONTROL Configure Subscriptions]**.
   ...
   ![Konfigurieren von Abonnements in CX Enterprise](assets/configure-subscriptions.png)
