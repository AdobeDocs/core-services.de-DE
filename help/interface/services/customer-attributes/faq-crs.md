---
description: Erhalten Sie Antworten auf häufig gestellte Fragen  [!DNL Customer Attributes]  in Adobe Experience Cloud, für Adobe Analytics und Adobe Target.
...
| Ist eine Migration zum Experience Cloud ID-Dienst erforderlich? | Die Migration hängt von den verwendeten Programmen ab. <ul><li>Adobe Analytics: dringend empfohlen </li><li>Adobe Target: erforderlich. </li></ul>Die Verwendung des Experience Cloud ID-Service ermöglicht die neuesten Experience Cloud-Funktionen, einschließlich Echtzeit-Zielgruppen, der Adobe Target-Modernisierung, der Analytics-Integration und der Video-Heartbeat-Verfolgung. |
