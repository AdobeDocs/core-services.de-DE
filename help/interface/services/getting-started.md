...
Wenn Sie Experience Cloud kürzlich mit [Experience Platform-Tags](https://experienceleague.adobe.com/en/docs/experience-platform/tags/home) implementiert haben, sind Sie bereits für [Kundenattribute](../services/overview.md) und Experience Cloud [Audiences](../services/audiences/overview.md) eingerichtet. Sie können auch Benutzer und Produkte in [Admin Console verwalten](../administration/admin-console.md).
...
>[!NOTE]
>
>Die vollständige Hilfe zum Experience Cloud ID-Service (früher Besucher-ID) finden Sie unter [Übersicht über den Experience Cloud Identity Service](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html#intro).
...
| --- | --- |
| [Implementieren des Experience Cloud ID-Dienstes für Analytics](https://experienceleague.adobe.com/en/docs/analytics/implementation/id/overview) | Adobe empfiehlt auch, zusätzliche [Kunden-IDs](https://experienceleague.adobe.com/en/docs/id-service/using/reference/authenticated-state) festzulegen. Diese IDs werden den einzelnen Besuchern zugeordnet und dienen der Aktivierung der aktuellen und zukünftigen Funktionen in Experience Cloud. |
