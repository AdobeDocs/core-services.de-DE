...
| **`s_ecid`** | 63115200 (2 Jahre) | ~45 Byte | Enthält eine Kopie der CX Enterprise ID (ECID/MID) im Format `s_ecid=MCMID\|<ECID>`. Fungiert als First-Party-Backup der ECID, insbesondere für CNAME-Szenarien (First-Party-Szenarien). |
