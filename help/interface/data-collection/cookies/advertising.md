...
>[!NOTE]
>
>Das JavaScript-Tag der Beta-Adobe Advertising, das den [Adobe Experience Cloud ID (ECID) Service verwendet](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html?lang=de) erstellt Erstanbieter-[Experience Cloud](experience-cloud.md) `s_ecid`-Cookies, nicht Adobe Advertising-Cookies.
